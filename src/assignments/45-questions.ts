...
//-----------------------------------
//exercise 20
const favoriteThings: string[] = ["mountains", "rivers", "languages"];
const favoriteObject: Record<string, string> = {
...
const mixedCaseString: string = 'TeSt';
...
const alienColor1: string = 'yellow'; // Change color to test different paths
if (alienColor1 === 'green') {
 ...
 //-----------------------------------
//exercise 27
const alienColor2: string = 'red'; // Change color to test different paths
...
//-----------------------------------
//exercise 28
const age: number = 25; // Change age to test different stages
if (age < 2) {
...
const currentUsers: string[] = ['John', 'Jane', 'admin', 'Eric', 'Alice'];
const newUsers: string[] = ['Bob', 'admin', 'Eve', 'Charlie', 'Alice'];
...
const favoritePizzas: string[] = ['Pepperoni', 'Margherita', 'Vegetarian'];
...
//-----------------------------------
//exercise 45
function carInformation(manufacturer: string, model: string, ...features: string[]): { manufacturer: string; model: string; features: string[] } {
    const car: { manufacturer: string; model: string; features: string[] } = {
        manufacturer,
        model,
        features,
    };
